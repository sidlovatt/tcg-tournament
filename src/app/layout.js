...
export const metadata = {
  ...
  description: "Run TCG tournaments anywhere — quick play with no account needed, or plan and list events for your local community.",
  keywords: ["TCG tournament", "Swiss pairings", "card game tournament", "Pokemon TCG tournament", "Magic the Gathering tournament", "tournament manager", "local TCG events", "find card game tournaments"],
  ...
  openGraph: {
    ...
    description: "Quick-play tournaments with no account, or plan and list events for your local community.",
