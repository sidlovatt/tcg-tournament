    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <img src="/icons/icon.png" alt="TCG Tournament" className="w-20 h-20 rounded-2xl mx-auto mb-4" />
          <h1 className="text-2xl font-bold text-slate-100">Sign in</h1>
          <p className="text-slate-400 text-sm mt-2">Required to create and manage tournaments</p>
        </div>
...
export default function SignIn() {
  return (
    <Suspense fallback={<main className="min-h-screen flex items-center justify-center"><p className="text-slate-500">Loading...</p></main>}>
      <SignInPage />
    </Suspense>
  )
}
