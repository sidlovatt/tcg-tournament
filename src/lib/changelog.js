export const CHANGELOG = [
  {
    date: '2026-05-19',
    changes: [
      'Player result claiming — submit result from your phone, TD confirms before it goes live',
      'Play page fills the screen on mobile',
      'Join page now shows game logo instead of card emoji',
      'Game dropdown defaults to Custom; Swiss selected by default',
